...
if (! defined('RCH_RECHAT_SDK_VERSION')) {
    define('RCH_RECHAT_SDK_VERSION', 'alpha');
}
...
include RCH_PLUGIN_INCLUDES . 'off-market/off-market-shortcode.php';
...
include RCH_PLUGIN_INCLUDES . 'portal/portal-log.php';
...
include RCH_PLUGIN_INCLUDES . 'shortcodes/testimonials-shortcode.php';
