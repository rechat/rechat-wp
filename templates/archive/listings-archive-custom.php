...
<div id="pagination" class="rch-house-pagination">
    ...
    <span id="page-info">Page 1 of <?php echo esc_html( ceil( $totalLisitng / $listingPerPage ) ); ?></span>
    <button id="next" onclick="changePage(1)">Next</button>
</div>

<script>
let currentPage = 1; // Initialize current page
const listingPerPage = <?php echo esc_js( $listingPerPage ); ?>; // Set number of listing per page
const totalListing = <?php echo esc_js( $totalLisitng ); ?>; // Set total number of listing
...
function updateListingList() {
    ...
    fetch(`<?php echo esc_url( admin_url('admin-ajax.php') ); ?>${queryString}`)
