...
<div id="primary" class="content-area rch-primary-content">
    <main id="main" class="site-main content-container site-container">
        ...
        while (have_posts()) : the_post();
            ...
            // Query for agents assigned to this office
            $args = array(
                'post_type' => 'agents',
                'meta_query' => array(
                    array(
                        'key' => '_rch_agent_offices',
                        'value' => sprintf('i:%d;', $office_id), // Searching for the specific office ID in the serialized array
                        'compare' => 'LIKE',
                    ),
                ),
            );
        ...
        <?php
                ...
                echo '<p>No agents assigned to this office.</p>';
            }
