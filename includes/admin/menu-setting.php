                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p><strong><?php _e('Custom Templates:', 'rch_rechat_plugin'); ?></strong>
                                <?php _e('If you create a file named', 'rch_rechat_plugin'); ?> <code><?php _e('agents-archive-custom.php', 'rch_rechat_plugin'); ?></code> <?php _e('in your theme\'s root directory, it will overwrite the default archive template. Similarly, if you create a file named', 'rch_rechat_plugin'); ?> <code><?php _e('agents-single-custom.php', 'rch_rechat_plugin'); ?></code> <?php _e('in the root directory, it will overwrite the default single agent template. For regions, create a file named', 'rch_rechat_plugin'); ?> <code><?php _e('regions-archive-custom.php', 'rch_rechat_plugin'); ?></code> <?php _e('to overwrite the default archive template, and', 'rch_rechat_plugin'); ?> <code><?php _e('regions-single-custom.php', 'rch_rechat_plugin'); ?></code> <?php _e('to overwrite the default single region template. For offices, create a file named', 'rch_rechat_plugin'); ?> <code><?php _e('offices-archive-custom.php', 'rch_rechat_plugin'); ?></code> <?php _e('to overwrite the default archive template, and', 'rch_rechat_plugin'); ?> <code><?php _e('offices-single-custom.php', 'rch_rechat_plugin'); ?></code> <?php _e('to overwrite the default single office template.', 'rch_rechat_plugin'); ?>
