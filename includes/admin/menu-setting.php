    ...
    <div class="wrap wrap-for-rechat">
        ...
        <div class="rch-setting-header">
            ...
            <h2 class="nav-tab-wrapper">
                ...
                <a href="?page=rechat-setting&tab=local-logic" class="nav-tab <?php echo $active_tab === 'lead-logic' ? 'nav-tab-active' : ''; ?>"><?php _e('Local Logic Settings', 'rch_rechat_plugin'); ?></a>
            </h2>
        </div>
        <?php settings_errors(); ?>
        <div id="tab-content">
