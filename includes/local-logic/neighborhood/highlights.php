...
<script
    ...
    onload="loadNeighborhoodHighlightsSDK()"></script>
<style>
...
<div id="neighborhood-highlights-widget"></div>
<script>
    const globalOptions = {
    ...
    function loadNeighborhoodHighlightsSDK() {
        ...
        const sdkInstance = ll.create("neighborhood-highlights", sdkContainer, sdkOptions);
    }
</script>